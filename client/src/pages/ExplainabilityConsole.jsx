            ...
            <div>
              ...
              <div className="space-y-2">
                <ConfidenceBar
                  ...
                  score={decision.score ?? (decision.reasoning?.length > 80 ? 88 : decision.reasoning?.length > 40 ? 76 : 65)}
                />
                <ConfidenceBar
                  label="Data Quality"
                  score={decision.dataQuality ?? (decision.type === 'goal_analysis' ? 92 : decision.type === 'skill_tree' ? 85 : decision.type === 'diagnostic' ? 80 : 75)}
                />
                <ConfidenceBar
                  label="Context Match"
                  score={decision.contextMatch ?? (decision.detail?.length > 100 ? 84 : decision.detail?.length > 50 ? 74 : 68)}
                />
              </div>
            </div>
